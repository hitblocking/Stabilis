...
namespace Bloxstrap.Resources {
    ...
    public class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Windows Tweaks.
        /// </summary>
        public static string Menu_WindowsTweak_Title {
            get {
                return ResourceManager.GetString("Menu.WindowsTweak.Title", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to HKLM system tweaks for multimedia scheduling, TCP latency, and game task priority. Run Stabilis as Administrator to apply registry changes..
        /// </summary>
        public static string Menu_WindowsTweak_Lead {
            get {
                return ResourceManager.GetString("Menu.WindowsTweak.Lead", resourceCulture);
            }
        }
